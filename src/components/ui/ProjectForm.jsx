          ...
          {BUDGETS.map(b => (
            <button
              ...
              style={{
                ...
                borderColor: form.budget === b ? 'rgba(123,167,212,0.45)' : 'rgba(255,255,255,0.09)',
                background: form.budget === b ? 'rgba(123,167,212,0.08)' : 'rgba(255,255,255,0.03)',
                color: form.budget === b ? '#7BA7D4' : 'rgba(255,255,255,0.3)',
